...
$(function() {
    ...
    $("input,textarea").jqBootstrapValidation({
        ...
        submitSuccess: function($form, event) {
            ...
            var url =
                "https://docs.google.com/forms/d/19l2NrC9es-7lEdquQL_cuWhPWgF" +
                "3eu0egErOQyumzjI/formResponse?ifq&entry.1101621315=" + name +
                "&entry.1925784277=" + email + "&entry.212009079=" + message +
                "&submit=Submit";
            window.location = url;
